...
<html lang="en">
  ...
  <body>	
	...
	<div class = "col-md-8 offset-md-2 vertical-center">
		<h1 style="text-align: center;">FamilyUs</h1>			
		<div class="col-md-6" id="hometext">		
		
			<p>Start using FamilyUs today and be one of the thousands of users uniting their families daily. Using our app would allow you
			to plan events, give chores to peoople and allow you to plan out your day with your entire family. Get started today!</p>
			
			<p><a href="<?php echo base_url(); ?>index.php/auth/register">Sign up,</a> its free!</p>
			
			<p>Have an account?<a href="<?php echo base_url(); ?>index.php/auth/login"> Login</a></p>
		</div>

		<img id="homepicture" class="col-md-6" src="<?php echo base_url(); ?>assets/img/homepicture.png">
	</div>
  </body>
</html>